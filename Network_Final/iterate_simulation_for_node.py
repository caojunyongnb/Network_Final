...
if __name__=='__main__':
    ...
    def calculate_centrality(load_model,strategy):
        if strategy=='BB':
            ...
            centrality = nx.degree_centrality((load_model))
        return centrality
    lm = load_model('power-US-Grid.mtx', theta=1.2, T=1.1)
    ...
    dbgraph=node_autorun(criterion,db_centrality)
    bbgraph=node_autorun(criterion, bb_centrality)

    print(len(dbgraph.edges()))
    print(len(bbgraph.edges()))
